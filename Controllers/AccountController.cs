    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(User user)
        {
            if (ModelState.IsValid)
            {
                ...
                var userType = isFirstUser ? TipoUsuario.Admin : TipoUsuario.Usuario;
        ...
        public IActionResult BuscarAlunosPorEmail(string email)
        {
            ...
            {
                return PartialView("_EmailSearchResults", new List<ApplicationUser>()); //Cria uma partial view com os resultados
            }
